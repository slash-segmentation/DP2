...
pretrainingEpochs = 10
trainingEpochs = 10


theano.config.blas.ldflags = "-Li:\\downloads\\OpenBLAS-develop\\OpenBLAS-develop -lopenblas"
...
def test_DBN(finetune_lr=0.1, pretraining_epochs=pretrainingEpochs,
             pretrain_lr=0.01, k=1, training_epochs=trainingEpochs,
