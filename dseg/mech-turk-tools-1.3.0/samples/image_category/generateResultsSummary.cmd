...
cd ..\..
cd bin
call generateResultsSummary -resultsFile ..\samples\image_category\image_category.results -outputFile ..\samples\image_category\image_category.summary -sample image_category
cd ..
